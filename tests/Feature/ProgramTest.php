...
class ProgramTest extends TestCase
{
    ...
    public function test_it_prevents_duplicate_attendance_for_same_student_and_session()
    {
        $student = Student::factory()->create();
        $program = Program::factory()->create();
    ...
    public function test_it_deducts_credit_when_student_is_marked_present()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
    ...
    public function test_it_refunds_credit_when_status_changes_from_present_to_excused()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
    ...
    public function test_it_does_not_refund_when_status_changes_from_present_to_absent()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
    ...
    public function test_it_does_not_deduct_credit_for_optional_sessions()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
    ...
    public function test_it_does_not_deduct_credit_for_students_with_infinite_sessions()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
    ...
    public function test_it_does_not_double_deduct_when_re_recording_present_status()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
    ...
    public function test_it_allows_credits_to_go_negative()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
    ...
    public function test_it_refunds_credits_when_session_changes_from_required_to_optional()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
        ...
        $controller = new ProgramSessionController;
    ...
    public function test_it_deducts_credits_when_session_changes_from_optional_to_required()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
    ...
    public function test_it_deducts_credit_for_late_excused_status()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
    ...
    public function test_it_deducts_credit_for_kicked_status()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
    ...
    public function test_it_deducts_credit_for_absent_status()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
    ...
    public function test_excused_is_the_only_status_that_does_not_deduct_credit()
    {
        $club = Club::factory()->create();
        $category = Category::factory()->create();
        $student = Student::factory()->create([
