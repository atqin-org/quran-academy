    ...
    return (
        <div className={cn("flex flex-col gap-2", containerClassName)}>
            <div
                ...
                className={cn(
                    "flex justify-center items-center w-full h-48 border-dashed border-2 border-gray-200 rounded-lg hover:bg-accent hover:text-accent-foreground transition-all select-none cursor-pointer",
                    dropZoneClassName
                )}
            >
                ...
                {children ? (
                    ...
                    >
                        ...
                        <span className="text-md truncate font-semibold text-gray-400">
                            {dropzone.isDragAccept
                                ? "ضع الملفات هنا"
