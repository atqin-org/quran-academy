...
export default function ProgramCreate({
    ...
    }, [dateRange, selectedDays, defaultStartTime, defaultEndTime]);
    ...
    const handleSubmit = () => {
        ...
        router.post(route("programs.store"), {
            name: data.name,
    ...
    return (
        <DashboardLayout user={auth.user}>
            <Head title="إنشاء برنامج جديد" />
            <div className="flex flex-col gap-6">
                {/* Header */}
                <div className="flex items-center justify-between">
                    <h1 className="text-3xl font-bold text-gray-900">إنشاء برنامج جديد</h1>
                </div>
                ...
                {step === 1 && (
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>أدخل المعلومات الأساسية للبرنامج</CardDescription>
                        </CardHeader>
